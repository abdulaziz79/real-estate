...
export const Home: React.FC = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (propertyType !== "All" && propertyType !== "Property Type")
  ...
  const destinations = [
    {
      ...
      img: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=600",
    },
    {
      name: "New York",
      country: "United States",
      img: "https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?auto=format&fit=crop&w=600",
    },
    {
      name: "Paris",
      country: "France",
      img: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=600",
    },
    {
      name: "London",
      country: "United Kingdom",
      img: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=600",
    },
  ];
  ...
  return (
    <div className="pt-0">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center px-4 pt-20">
          ...
          <h1 className="text-6xl md:text-9xl font-bold text-white mb-8 leading-none tracking-tighter">
            Redefining <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-200 to-blue-300">
              Modern Living
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
            Access an exclusive portfolio of the world's most prestigious
            estates. <br className="hidden md:block" />
            Powered by advanced intelligence. Tailored for your legacy.
          </p>

          <form
            onSubmit={handleSearch}
            className="glass-morphism p-3 rounded-[3rem] shadow-2xl max-w-5xl mx-auto border-white/20"
          >
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <button
                type="submit"
                className="bg-blue-600 text-white px-14 py-6 rounded-[2rem] font-black uppercase tracking-[0.2em] text-sm hover:bg-blue-700 transition-all shadow-xl hover:-translate-y-1 active:translate-y-0"
              >
                Search
              </button>
            </div>
      ...
      <section className="relative z-20 -mt-16 max-w-7xl mx-auto px-4">
        <div className="bg-white rounded-[4rem] shadow-2xl border border-slate-100 p-12 grid grid-cols-2 lg:grid-cols-4 gap-12">
          {[
            ...
            <div
              key={i}
              className="text-center border-r last:border-none border-slate-100 px-4"
            >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            ...
            <p className="text-slate-500 max-w-md font-medium text-xl leading-relaxed">
              Access curated property markets in the most influential cities
              across the globe.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {destinations.map((dest, i) => (
              <div
                ...
                onClick={() =>
                  navigate(
                    `/listings?country=${dest.country}&city=${dest.name}`,
                  )
                }
            ...
            {[
              {
                ...
                desc: "Bespoke strategy for high-net-worth individuals managing multi-country asset portfolios.",
              },
              {
                title: "Market Intelligence",
                icon: "M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9",
                desc: "Real-time cross-border data analytics and legal compliance verification for global investors.",
              },
              {
                title: "AI Matching Engine",
                icon: "M13 10V3L4 14h7v7l9-11h-7z",
                desc: "Proprietary Gemini algorithms that identify high-yield investment opportunities before they hit the public market.",
              },
            ].map((service, i) => (
              <div
                key={i}
                className="bg-white p-14 rounded-[4rem] shadow-sm border border-slate-100 hover:shadow-2xl transition-all group hover:-translate-y-2"
              >
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            ...
            <Link
              to="/listings"
              className="group bg-slate-900 text-white px-10 py-5 rounded-[2rem] font-bold flex items-center gap-4 hover:bg-slate-800 transition-all shadow-2xl"
            >
              View Full Portfolio
              <svg
      ...
      <section className="py-32 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-24">
            <h2 className="text-5xl font-bold tracking-tighter mb-6 text-white">
              The Standard of Excellence
            </h2>
            <p className="text-blue-400 font-black uppercase tracking-[0.3em] text-xs italic">
            ...
            {[
              {
                ...
                text: "The depth of market insight provided by the Elite platform is unparalleled. I successfully acquired properties in three different continents in record time.",
                img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=200",
              },
              {
                name: "Isabella Rossi",
                role: "Creative Director",
                text: "Finding a home is emotional, but finding an asset is logical. Elite Realty Pro perfectly balances both with their AI and expert agents.",
                img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200",
              },
              {
                name: "Jordan Hayes",
                role: "Tech Entrepreneur",
                text: "The virtual tour and direct agent communication features make overseas purchasing a breeze. Truly the future of real estate.",
                img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=200",
              },
            ].map((t, i) => (
              <div
                key={i}
                className="bg-white/5 backdrop-blur-xl p-12 rounded-[4rem] border border-white/10 hover:bg-white/10 transition-all group"
              >
