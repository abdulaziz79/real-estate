        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 flex items-center gap-2" onClick={handleLinkClick}>
                ...
                <div className="relative">
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-3 w-48 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 animate-in fade-in slide-in-from-top-2">
                      ...
                      {user.role === 'admin' && (
                        <Link to="/admin" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 font-medium" onClick={handleLinkClick}>Dashboard</Link>
                      )}
                      {user.role === 'agent' && (
                        <Link to="/agent/dashboard" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 font-medium" onClick={handleLinkClick}>My Dashboard</Link>
                      )}
                      <Link to="/messages" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 font-medium" onClick={handleLinkClick}>Messages</Link>
