    ...
    <div className="pt-0">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/hero.jpg" className="w-full h-full object-cover animate-pulse-slow" alt="Elite Realty Hero" />
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            ...
            <p className="text-slate-500 max-w-md font-medium text-xl leading-relaxed">
              Access curated property markets in the most influential cities across the globe.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {destinations.map((dest, i) => (
              <div
                key={i}
                onClick={() => router.push(`/listings?country=${encodeURIComponent(dest.country)}&city=${encodeURIComponent(dest.name)}`)}
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            ...
            <Link href="/listings" className="group bg-slate-900 text-white px-10 py-5 rounded-[2rem] font-bold flex items-center gap-4 hover:bg-slate-800 transition-all shadow-2xl">
              View Full Portfolio
