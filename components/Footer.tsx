        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#/listings" className="hover:text-blue-500 transition-colors">Property Listings</a></li>
              <li><a href="#/agents" className="hover:text-blue-500 transition-colors">Find an Agent</a></li>
              <li><a href="#/about" className="hover:text-blue-500 transition-colors">About Company</a></li>
